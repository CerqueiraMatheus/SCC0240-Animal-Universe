...
CREATE TABLE ALERTA_RELATO(
    ALERTA NUMERIC(5),
    RELATO NUMERIC(5),
    CONSTRAINT PK_ALERTA_ORGANIZACAO PRIMARY KEY (ALERTA, RELATO),
    CONSTRAINT FK_ALERTA FOREIGN KEY (ALERTA) REFERENCES ALERTA(ID),
...
CREATE TABLE AUDIO(
    RELATO NUMERIC(5),
    AUDIO VARCHAR(300),
    CONSTRAINT PK_FOTO PRIMARY KEY (RELATO, AUDIO),
    CONSTRAINT FK_RELATO FOREIGN KEY (RELATO) REFERENCES RELATO(ID)
);
...
CREATE TABLE ANIMAL_FOTO(
    ANIMAL NUMERIC(5),
    FOTO VARCHAR(300),
    CONSTRAINT PK_FOTO PRIMARY KEY (ANIMAL, FOTO),
...
CREATE TABLE ANIMAL_VIDEO(
    ANIMAL NUMERIC(5),
    VIDEO VARCHAR(300),
    CONSTRAINT PK_VIDEO PRIMARY KEY (ANIMAL, VIDEO),
    CONSTRAINT FK_RELATO FOREIGN KEY (ANIMAL) REFERENCES ANIMAL(ID)
);
...
CREATE TABLE ANIMAL_AUDIO(
    ANIMAL NUMERIC(5),
    AUDIO VARCHAR(300),
    CONSTRAINT PK_FOTO PRIMARY KEY (ANIMAL, AUDIO),
    CONSTRAINT FK_RELATO FOREIGN KEY (ANIMAL) REFERENCES ANIMAL(ID)
);

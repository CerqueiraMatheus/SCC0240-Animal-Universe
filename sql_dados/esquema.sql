...
CREATE TABLE BIOLOGO(
    ...
    CONSTRAINT FK_ID FOREIGN KEY (ID) REFERENCES USUARIO(ID) ON DELETE CASCADE
);
...
CREATE TABLE FUNCIONARIO(
    ...
    CONSTRAINT FK_ID FOREIGN KEY (ID) REFERENCES USUARIO(ID) ON DELETE CASCADE,
    CONSTRAINT FK_ZOOLOGICO FOREIGN KEY (ZOOLOGICO) REFERENCES ZOOLOGICO(CNPJ) ON DELETE CASCADE
);

CREATE TABLE CUIDADOR(
    ID NUMERIC(5),
    CONSTRAINT PK_CUIDADOR PRIMARY KEY (ID),
    CONSTRAINT FK_ID FOREIGN KEY (ID) REFERENCES FUNCIONARIO(ID) ON DELETE CASCADE
);
...
CREATE TABLE CERTIFICACAO(
    ...
    CONSTRAINT FK_CERTIFICACAO FOREIGN KEY (ID) REFERENCES ORGANIZACAO(ID) ON DELETE CASCADE
);
...
CREATE TABLE ALERTA(
    ...
    CONSTRAINT FK_BIOLOGO FOREIGN KEY (BIOLOGO) REFERENCES BIOLOGO(ID) ON DELETE CASCADE
);
...
CREATE TABLE RELATO(
    ...
    CONSTRAINT FK_ANIMAL FOREIGN KEY (ANIMAL) REFERENCES ANIMAL(ID) ON DELETE CASCADE,
...
CREATE TABLE ALERTA_ORGANIZACAO(
    ...
    CONSTRAINT FK_ALERTA FOREIGN KEY (ALERTA) REFERENCES ALERTA(ID) ON DELETE CASCADE,
    CONSTRAINT FK_ORGANIZACAO FOREIGN KEY (ORGANIZACAO) REFERENCES ORGANIZACAO(ID) ON DELETE CASCADE
);
...
CREATE TABLE ALERTA_RELATO(
    ...
    CONSTRAINT FK_ALERTA FOREIGN KEY (ALERTA) REFERENCES ALERTA(ID) ON DELETE CASCADE,
    CONSTRAINT FK_RELATO FOREIGN KEY (RELATO) REFERENCES RELATO(ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT FK_ZOOLOGICO FOREIGN KEY (ZOOLOGICO) REFERENCES ZOOLOGICO(CNPJ) ON DELETE CASCADE,
    CONSTRAINT FK_ANIMAL FOREIGN KEY (ANIMAL) REFERENCES ANIMAL(ID) ON DELETE CASCADE,
    CONSTRAINT FK_GESTOR FOREIGN KEY (GESTOR) REFERENCES GESTOR(ID) ON DELETE CASCADE
);
...
CREATE TABLE ANIMAL_FOTO(
    ...
    CONSTRAINT FK_RELATO FOREIGN KEY (ANIMAL) REFERENCES ANIMAL(ID) ON DELETE CASCADE
);
...
CREATE TABLE PREDACAO(
    ...
    CONSTRAINT FK_PRESA FOREIGN KEY (PRESA) REFERENCES ANIMAL(ID) ON DELETE CASCADE,
    CONSTRAINT FK_PREDADOR FOREIGN KEY (PREDADOR) REFERENCES ANIMAL(ID) ON DELETE CASCADE
);
...
CREATE TABLE APADRINHAMENTO(
    ...
    GESTOR NUMERIC(5),
    VALOR NUMERIC(6, 2)
    CONSTRAINT DATAS CHECK(DATA_INICIAL < DATA_FINAL)
);
...
CREATE TABLE ESTADO(
    ...
    CONSTRAINT FK_ESPECIME FOREIGN KEY (ESPECIME) REFERENCES ESPECIME(ID) ON DELETE CASCADE,
    CONSTRAINT FK_CUIDADOR FOREIGN KEY (CUIDADOR) REFERENCES CUIDADOR(ID) ON DELETE CASCADE
);
...
CREATE TABLE CONSULTA(
    ...
    CONSTRAINT FK_ESPECIME FOREIGN KEY (ESPECIME) REFERENCES ESPECIME(ID) ON DELETE CASCADE,
    CONSTRAINT FK_VETERINARIO FOREIGN KEY (VETERINARIO) REFERENCES VETERINARIO(ID) ON DELETE CASCADE
);
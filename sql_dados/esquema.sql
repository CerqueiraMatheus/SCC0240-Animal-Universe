...
-- Cria sequência de ID de usuário
...
-- Cria tabela de funcionário de zoológico
...
-- Cria tabela de cuidador de zoológico
...
-- Cria tabela de veterinário de zoológico
...
-- Cria tabela de gestor de zoológico
CREATE TABLE GESTOR(
    ID NUMERIC(5),
...
-- Cria tabela de certificação da organização
...
-- Cria sequência de ID de alerta
CREATE SEQUENCE ALERTA_ID_SEQ;

-- Cria tabela de alerta
CREATE TABLE ALERTA(
...
-- Cria sequência de ID de animal
...
-- Cria sequência de ID de relato
CREATE SEQUENCE RELATO_ID_SEQ;

-- Cria tabela de relato de animal
CREATE TABLE RELATO(
...
-- Cria tabela de relacionamento de organização com alerta
...
-- Cria sequência de ID de comentário em relato de animal
CREATE SEQUENCE COMENTARIO_RELATO_ID_SEQ;

-- Cria tabela de comentário em relato
...
-- Cria sequência de ID de comentário em animal
CREATE SEQUENCE COMENTARIO_ANIMAL_ID_SEQ;

-- Cria tabela de comentário em animal
